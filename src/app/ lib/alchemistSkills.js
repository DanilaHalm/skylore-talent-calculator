...
const alchemistUltimates = [
  {
    ...
    requiredLvl: "reqLvl",
    icon: "../../public/alchemist/elixirOfLife.jpg",
  },
  //{
  //  index: 9,
  //  name: "name9",
...
const alchemistSkills = [
  {
    ...
    description: "description",
    requiredLvl: "reqLvl",
    icon: "../../public/alchemist/directionalTransformation.jpg",
  },
  {
    index: 2,
    name: "name2",
    description: "description",
    requiredLvl: "reqLvl",
    icon: "../../public/alchemist/transmutationCircle.jpg",
  },
  {
    index: 3,
    name: "name3",
    description: "description",
    requiredLvl: "reqLvl",
    icon: "../../public/alchemist/healingElixir.jpg",
  },
  {
    index: 4,
    name: "name4",
    description: "description",
    requiredLvl: "reqLvl",
    icon: "../../public/alchemist/protectiveBarrier.jpg",
  },
  {
    index: 5,
    name: "name5",
    description: "description",
    requiredLvl: "reqLvl",
    icon: "../../public/alchemist/unstableMixture.jpg",
  },
  {
    index: 6,
    name: "name6",
    description: "description",
    requiredLvl: "reqLvl",
    icon: "../../public/alchemist/healingTransmutation.jpg",
  },
  {
    index: 7,
    name: "name7",
    description: "description",
    requiredLvl: "reqLvl",
    icon: "../../public/alchemist/potionMaking.jpg",
  },
  {
    index: 8,
    name: "name8",
